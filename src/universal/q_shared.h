...
#define CONTENTS_ANY_TRIGGER \
    (CONTENTS_VEHICLETRIGGER | CONTENTS_AXISTRIGGER | CONTENTS_ALLIESTRIGGER | \
     CONTENTS_NEUTRALTRIGGER | CONTENTS_NONSENTIENTTRIGGER | CONTENTS_PLAYERTRIGGER)
...
#define MASK_AIMTARGET_VISIBILITY \
    (CONTENTS_SOLID | CONTENTS_FOLIAGE | CONTENTS_AI_NOSIGHT | \
     CONTENTS_CLIPSHOT | CONTENTS_VEHICLE)

#define MASK_PLAYER_VISIBILITY \
    (CONTENTS_SOLID | CONTENTS_AI_NOSIGHT | CONTENTS_CLIPSHOT | \
     CONTENTS_VEHICLE | CONTENTS_PLAYER)

#define MASK_ADS_DOF_TRACE \
    (CONTENTS_SOLID | CONTENTS_GLASS | CONTENTS_WATER | CONTENTS_ITEMCLIP | \
     CONTENTS_SKY | CONTENTS_CLIPSHOT | CONTENTS_ACTOR | CONTENTS_VEHICLE)

#define MASK_HELI_DUST_TRACE \
    (CONTENTS_SOLID | CONTENTS_GLASS | CONTENTS_WATER | CONTENTS_SKY)

#if KISAK_MP
#define MASK_CHARACTER \
    CONTENTS_PLAYER
#elif KISAK_SP
#define MASK_CHARACTER \
    (CONTENTS_PLAYER | CONTENTS_ACTOR | CONTENTS_FAKE_ACTOR)
#endif

#define MASK_IGNORE_CHARACTERS \
    (~MASK_CHARACTER)

#define MASK_DEADSOLID \
    (MASK_PLAYERSOLID & ~CONTENTS_PLAYER)

...
#ifdef KISAK_MP
            G_Damage(ent, pusher, pusher, 0, 0, 99999, DAMAGE_NOFLAG, 9, 0xFFFFFFFF, HITLOC_NONE, 0, 0, 0);
#elif KISAK_SP
            G_Damage(ent, pusher, pusher, 0, 0, 99999, DAMAGE_NOFLAG, 9, 0xFFFFFFFF, HITLOC_NONE, 0, 0);
#endif
        }
    }
    for (j = 0; j < v10; ++j)

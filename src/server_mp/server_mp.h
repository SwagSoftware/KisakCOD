...
{
  { NETF_HUD(color.rgba), 0x0FFFFFFAB, 0u },
  { NETF_HUD(fadeStartTime), 0x0FFFFFF9F, 0u },
  { NETF_HUD(fromColor.rgba), 0x0FFFFFFAB, 0u },
  { NETF_HUD(y), 0x0FFFFFFA5, 0u },
  { NETF_HUD(type), 4, 0u },
  { NETF_HUD(materialIndex), 8, 0u },
  { NETF_HUD(height), 10, 0u },
  { NETF_HUD(width), 10, 0u },
  { NETF_HUD(x), 0xFFFFFFA4, 0u },
  { NETF_HUD(fadeTime), 16, 0u },
  { NETF_HUD(z), 0xFFFFFFA6, 0u },
  { NETF_HUD(value), 0, 0u },
  { NETF_HUD(alignScreen), 6, 0u },
  { NETF_HUD(sort), 0, 0u },
  { NETF_HUD(alignOrg), 4, 0u },
  { NETF_HUD(offscreenMaterialIdx), 8, 0u },
  { NETF_HUD(fontScale), 0xFFFFFFAA, 0u },
  { NETF_HUD(text), 9, 0u },
  { NETF_HUD(font), 4, 0u },
  { NETF_HUD(scaleStartTime), 0xFFFFFF9F, 0u },
  { NETF_HUD(scaleTime), 16, 0u },
  { NETF_HUD(fromWidth), 10, 0u },
  { NETF_HUD(fromHeight), 10, 0u },
  { NETF_HUD(targetEntNum), 10, 0u },
  { NETF_HUD(glowColor.rgba), 0xFFFFFFAB, 0u },
  { NETF_HUD(fxBirthTime), 0xFFFFFF9F, 0u },
  ...
  { NETF_HUD(flags), 3, 0u },
  { NETF_HUD(label), 9, 0u },
  { NETF_HUD(time), 0xFFFFFF9F, 0u },
  { NETF_HUD(moveStartTime), 0xFFFFFF9F, 0u },
  { NETF_HUD(moveTime), 16, 0u },
  { NETF_HUD(fromX), 0xFFFFFF9D, 0u },
  { NETF_HUD(fromY), 0xFFFFFF9D, 0u },
...
{
  { NETF(eType), 8, 1u },
  { NETF(lerp.pos.trTime), 0xFFFFFF9F, 0u },
  { NETF(lerp.pos.trBase[0]), 0xFFFFFFA4, 0u },
  { NETF(lerp.pos.trBase[1]), 0xFFFFFFA5, 0u },
  { NETF(lerp.pos.trDelta[0]), 0, 0u },
  { NETF(lerp.pos.trDelta[1]), 0, 0u },
  { NETF(lerp.u.vehicle.gunYaw), 0, 0u },
  { NETF(lerp.apos.trBase[1]), 0xFFFFFF9C, 0u },
  { NETF(lerp.pos.trBase[2]), 0xFFFFFFA6, 0u },
  { NETF(lerp.pos.trDelta[2]), 0, 0u },
  { NETF(lerp.apos.trBase[0]), 0xFFFFFF9C, 0u },
  { NETF(eventSequence), 8, 0u },
  { NETF(legsAnim), 10, 0u },
  { NETF(surfType), 8, 0u },
  { NETF(otherEntityNum), 10, 0u },
  { NETF(un1), 8, 0u },
  { NETF(lerp.eFlags), 0xFFFFFF9E, 0u },
  { NETF(groundEntityNum), 0xFFFFFFA0, 0u },
  { NETF(clientNum), 7, 0u },
  { NETF(events[0]), 0xFFFFFFA2, 0u },
  { NETF(events[1]), 0xFFFFFFA2, 0u },
  { NETF(events[2]), 0xFFFFFFA2, 0u },
  { NETF(weapon), 7, 0u },
  { NETF(weaponModel), 4, 0u },
  { NETF(eventParms[1]), 0xFFFFFFA3, 0u },
  { NETF(eventParms[0]), 0xFFFFFFA3, 0u },
  { NETF(eventParms[2]), 0xFFFFFFA3, 0u },
  { NETF(index), 10, 0u },
  { NETF(lerp.u.vehicle.materialTime), 0xFFFFFF9F, 0u },
  { NETF(lerp.pos.trType), 8, 0u },
  { NETF(lerp.apos.trType), 8, 0u },
  { NETF(events[3]), 0xFFFFFFA2, 0u },
  { NETF(lerp.apos.trBase[2]), 0xFFFFFF9C, 0u },
  { NETF(lerp.apos.trTime), 32, 0u },
  { NETF(lerp.apos.trDelta[0]), 0, 0u },
  { NETF(lerp.apos.trDelta[2]), 0, 0u },
  { NETF(torsoAnim), 10, 0u },
  { NETF(eventParms[3]), 0xFFFFFFA3, 0u },
  { NETF(lerp.u.vehicle.gunPitch), 0, 0u },
  { NETF(solid), 24, 0u },
  { NETF(lerp.pos.trDuration), 32, 0u },
  { NETF(lerp.apos.trDelta[1]), 0, 0u },
  { NETF(un2), 32, 0u },
  { NETF(time2), 0xFFFFFF9F, 0u },
  { NETF(loopSound), 8, 0u },
  { NETF(attackerEntityNum), 10, 0u },
  { NETF(fWaistPitch), 0, 0u },
  { NETF(fTorsoPitch), 0, 0u },
  { NETF(lerp.u.vehicle.bodyPitch), 0xFFFFFF9C, 0u },
  { NETF(lerp.u.vehicle.bodyRoll), 0xFFFFFF9C, 0u },
  { NETF(iHeadIcon), 4, 0u },
  { NETF(iHeadIconTeam), 2, 0u },
  { NETF(eventParm), 0xFFFFFFA3, 0u },
...
{
  { NETF_PL(commandTime), 0xFFFFFF9F, 0u },
  { NETF_PL(viewangles[1]), 0xFFFFFFA9, 0u },
  { NETF_PL(viewangles[0]), 0xFFFFFFA9, 0u },
  { NETF_PL(viewangles[2]), 0xFFFFFFA9, 0u },
  { NETF_PL(origin[0]), 0xFFFFFFA8, 3u },
  { NETF_PL(origin[1]), 0xFFFFFFA8, 3u },
  { NETF_PL(bobCycle), 8, 3u },
  { NETF_PL(velocity[1]), 0xFFFFFFA8, 3u },
  { NETF_PL(velocity[0]), 0xFFFFFFA8, 3u },
  { NETF_PL(movementDir), 0xFFFFFFF8, 3u },
  { NETF_PL(eventSequence), 8, 0u },
  { NETF_PL(legsAnim), 10, 0u },
  { NETF_PL(origin[2]), 0xFFFFFFA8, 3u },
  { NETF_PL(weaponTime), 0xFFFFFFF0, 0u },
  { NETF_PL(aimSpreadScale), 0xFFFFFFA8, 0u },
  { NETF_PL(torsoTimer), 16, 0u },
  { NETF_PL(pm_flags), 21, 0u },
  { NETF_PL(weapAnim), 10, 0u },
  { NETF_PL(weaponstate), 5, 0u },
  { NETF_PL(velocity[2]), 0xFFFFFFA8, 3u },
  ...
  { NETF_PL(holdBreathScale), 0xFFFFFFA8, 0u },
  { NETF_PL(eFlags), 0xFFFFFF9E, 0u },
  { NETF_PL(viewHeightCurrent), 0xFFFFFFA8, 0u },
  { NETF_PL(fWeaponPosFrac), 0xFFFFFFA8, 0u },
  { NETF_PL(legsTimer), 16, 0u },
  { NETF_PL(viewHeightTarget), 0xFFFFFFF8, 0u },
  { NETF_PL(sprintState.lastSprintStart), 0xFFFFFF9F, 0u },
  { NETF_PL(sprintState.lastSprintEnd), 0xFFFFFF9F, 0u },
  { NETF_PL(weapon), 7, 0u },
  { NETF_PL(weaponDelay), 0xFFFFFFF0, 0u },
  ...
  { NETF_PL(delta_angles[1]), 0xFFFFFF9C, 0u },
  { NETF_PL(offHandIndex), 7, 0u },
  { NETF_PL(pm_time), 0xFFFFFFF0, 0u },
  ...
  { NETF_PL(delta_angles[0]), 0xFFFFFF9C, 0u },
  { NETF_PL(speed), 16, 0u },
  ...
  { NETF_PL(viewHeightLerpTarget), 0xFFFFFFF8, 0u },
  ...
  { NETF_PL(cursorHintString), 0xFFFFFFF8, 0u },
  ...
  { NETF_PL(throwBackGrenadeTimeLeft), 0xFFFFFFF0, 0u },
  { NETF_PL(weaponold[3]), 32, 0u },
  { NETF_PL(weaponold[1]), 32, 0u },
  { NETF_PL(foliageSoundTime), 0xFFFFFF9F, 0u },
  ...
  { NETF_PL(meleeChargeTime), 0xFFFFFF9F, 0u },
  { NETF_PL(meleeChargeYaw), 0xFFFFFF9C, 0u },
  ...
  { NETF_PL(weaponRestrictKickTime), 0xFFFFFFF0, 0u },
  { NETF_PL(delta_angles[2]), 0xFFFFFF9C, 0u },
...
const NetField archivedEntityFields[69] = // LWSS: change SV_GetAnalyzeEntityFields() if you edit this
{
  ...
  { NETF_ARC(lerp.eFlags), 0xFFFFFF9E, 0u },
  { NETF_ARC_A(svFlags), 32, 0u },
  { NETF_ARC(events[0]), 8, 0u },
  { NETF_ARC(eventSequence), 8, 0u },
  { NETF_ARC(index), 10, 0u },
  { NETF_ARC(legsAnim), 10, 0u },
  { NETF_ARC(events[1]), 0xFFFFFFA2, 0u },
  { NETF_ARC(events[2]), 0xFFFFFFA2, 0u },
  { NETF_ARC(events[3]), 0xFFFFFFA2, 0u },
  ...
  { NETF_ARC(eventParms[0]), 0xFFFFFFA3, 0u },
  { NETF_ARC(torsoAnim), 10, 0u },
  { NETF_ARC(lerp.u.anonymous.data[1]), 32, 0u },
  { NETF_ARC(lerp.pos.trTime), 0xFFFFFF9F, 0u },
  ...
  { NETF_ARC(eventParms[1]), 0xFFFFFFA3, 0u },
  { NETF_ARC(surfType), 8, 0u },
  { NETF_ARC(eventParm), 0xFFFFFFA3, 0u },
  { NETF_ARC(eventParms[2]), 0xFFFFFFA3, 0u },
  { NETF_ARC(un1), 8, 0u },
  { NETF_ARC(eventParms[3]), 8, 0u },
  { NETF_ARC(lerp.pos.trDuration), 32, 0u },
  { NETF_ARC(fWaistPitch), 0, 0u },
  { NETF_ARC(fTorsoPitch), 0, 0u },
  { NETF_ARC(lerp.apos.trTime), 0xFFFFFF9F, 0u },

...
{
  { NETF(eType), 8, 1u },
  { NETF(lerp.pos.trBase[0]), 0xFFFFFFA4, 2u },
  { NETF(lerp.pos.trBase[1]), 0xFFFFFFA5, 2u },
  { NETF(lerp.u.player.movementDir), 0xFFFFFFF8, 0u },
  { NETF(lerp.apos.trBase[1]), 0xFFFFFF9C, 0u },
  { NETF(lerp.pos.trBase[2]), 0xFFFFFFA6, 0u },
  { NETF(eventSequence), 8, 0u },
  { NETF(lerp.apos.trBase[0]), 0xFFFFFF9C, 0u },
  ...
  { NETF(lerp.pos.trTime), 0xFFFFFF9F, 1u },
...
const NetField corpseEntityStateFields[59] =
{
  ...
  { NETF(lerp.pos.trDelta[1]), 0, 0u },
  { NETF(lerp.pos.trDelta[2]), 0, 0u },
  { NETF(lerp.u.player.movementDir), 0xFFFFFFF8, 1u },
  { NETF(eventSequence), 8, 1u },
  { NETF(events[0]), 0xFFFFFFA2, 1u },
  { NETF(events[1]), 0xFFFFFFA2, 1u },
  { NETF(events[2]), 0xFFFFFFA2, 1u },
  { NETF(events[3]), 0xFFFFFFA2, 1u },
  { NETF(fTorsoPitch), 0, 1u },
  { NETF(eventParms[1]), 0xFFFFFFA3, 1u },
  { NETF(eventParms[0]), 0xFFFFFFA3, 1u },
  { NETF(eventParms[2]), 0xFFFFFFA3, 1u },
  { NETF(weapon), 7, 1u },
  { NETF(weaponModel), 4, 1u },
  { NETF(eventParms[3]), 0xFFFFFFA3, 1u },
  { NETF(solid), 24, 1u },
  { NETF(lerp.pos.trDuration), 32, 1u },
  { NETF(fWaistPitch), 0, 1u },
  { NETF(eventParm), 0xFFFFFFA3, 1u },
  { NETF(iHeadIcon), 4, 1u },
...
const NetField itemEntityStateFields[59] =
{
  ...
  { NETF(lerp.apos.trTime), 0xFFFFFF9F, 2u },
...
const NetField fxStateFields[59] =
{
  ...
  { NETF(clientNum), 7, 0u },
  { NETF(lerp.apos.trType), 8, 0u },
  { NETF(lerp.apos.trTime), 0xFFFFFF9F, 0u },
  { NETF(lerp.apos.trDelta[0]), 0, 0u },
  { NETF(lerp.apos.trDelta[1]), 0, 0u },
  { NETF(lerp.apos.trDelta[2]), 0, 0u },
  { NETF(index), 10, 0u },
...
const NetField missileEntityStateFields[59] =
{
  ...
  { NETF(surfType), 8, 0u },
  { NETF(lerp.apos.trDelta[2]), 0, 0u },
  { NETF(lerp.u.missile.launchTime), 0xFFFFFF9F, 0u },
  { NETF(weapon), 7, 0u },
  { NETF(eventParms[0]), 0xFFFFFFA3, 0u },
  { NETF(events[0]), 0xFFFFFFA2, 0u },
  { NETF(events[1]), 0xFFFFFFA2, 0u },

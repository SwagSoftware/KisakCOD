...
// KISAKTODO: This relies on the old fopen() from the old Windows CRT that changed in 2015. It needs refactoring...
// This is just placeholder for now
struct windows_fixme_iobuf
{
    char *_ptr;                         // ...
    int _cnt;                           // ...
    char *_base;                        // ...
